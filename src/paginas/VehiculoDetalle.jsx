...
export default function VehiculoDetalle() {
    ...
    return (
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        <div className="rounded-2xl border border-black/10 bg-white/70 p-6 sm:p-8">
          ...
          <Link
            to="/vehiculos"
            className="mt-2 inline-block text-sm underline text-black/70 hover:text-black"
          >
            Volver a vehículos
          </Link>
        </div>
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
      <div className="rounded-3xl border border-black/10 bg-white/50 backdrop-blur p-5 sm:p-6 md:p-8 shadow-[0_10px_35px_rgba(0,0,0,0.08)]">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-2xl sm:text-3xl md:text-4xl font-semibold text-black leading-tight">
...
{/* Chips: wrap en móvil */}
        ...
        {/* Cuerpo */}
        <div className="mt-7 sm:mt-8 grid grid-cols-1 lg:grid-cols-[1.35fr_.65fr] gap-6">
          {/* Imagen + contenido */}
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-black/10 bg-white/70 p-5 sm:p-6">
            ...
            {/* Ficha técnica extra SOLO móvil/tablet (para que no quede "perdida") */}
            <div className="lg:hidden rounded-2xl border border-black/10 bg-white/70 p-5 sm:p-6">
          ...
          <aside className="hidden lg:block rounded-2xl border border-black/10 bg-white/70 p-6 h-fit sticky top-6">
            <h2 className="text-lg font-semibold text-black">Ficha técnica</h2>
            <div className="mt-4 divide-y divide-black/10">
              <Spec label="Marca" value={vehiculo.marca} />
              <Spec label="Modelo" value={vehiculo.modelo} />
